...
const MyPostModal = () => {
  ...
  const { user, getRelativeTime, getLoggedInUserInfor } = useAuth();
  const {
    posts,
    newComment,
    setNewComment,
    ...
    <>
      <div className="fixed inset-0 backdrop-brightness-50 flex items-center justify-center z-[9999]">
        ...
        >
          ...
          <PostTopBar closeModal={closeModal} title={"My Post"} />
          ...
          <div className="w-full sm:w-1/2 h-1/2 sm:h-full overflow-y-auto flex flex-col justify-between">
            <div>
              <div
                className={`hidden lg:flex items-center space-x-2 justify-between border-b border-gray-300 p-2 sticky top-0 ${styles.bg} z-10`}
              >
                <div className="flex items-center gap-2">
                  <img
                    title={`${user.username}`}
              ...
              {/* Small screens comments summary */}
              <div className="sm:hidden p-3">
                <div className="flex items-center space-x-2 justify-between mb-4 w-full h-full">
            ...
            {isPostDeleting && <LoadingModal text={"Deleting Post"} />}

            <div className={`sticky bottom-0 ${styles.bg} p-2`}>
              <div className="hidden lg:flex items-center space-x-2 justify-between border-t border-gray-300">
                <div className="flex items-center gap-4 cursor-pointer mt-2">
                  {hasLiked ? (
                    <Icon.HeartFilled
                      size={24}
                      onClick={() => handleLike(post._id)}
