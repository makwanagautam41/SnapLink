...
import FeedSkeleton from "./SkeletonLoaders/FeedSkeletonLoader";
    ...
    <div className="w-full">
      ...
      <div className="relative">
        <div className="flex items-center">
          <button
            onClick={scrollLeft}
            className={`hidden md:flex absolute left-0 z-10 cursor-pointer p-1 rounded-full shadow-md ${styles.hover} ${styles.bg2}`}
          ...
          <button
            onClick={scrollRight}
            className={`hidden md:flex absolute right-0 z-10 cursor-pointer p-1 rounded-full shadow-md ${styles.hover} ${styles.bg2}`}
      ...
      <div className="space-y-4 mb-10">
        {loadingPosts ? (
          ...
          feed.map((post) => (
            <div key={post._id} className={`rounded-lg shadow-md ${styles.bg}`}>
